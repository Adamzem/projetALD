...
var SuggestionsContext = /*#__PURE__*/React__default.createContext({});
function withSuggestionsContext(OriginalComponent) {
  return getContextAwareComponent(SuggestionsContext, OriginalComponent);
}
var MessageContentContext = /*#__PURE__*/React__default.createContext({});
...
var KeyboardContext = /*#__PURE__*/React__default.createContext({
  dismissKeyboard: reactNative.Keyboard.dismiss
});
...
var getContextAwareComponent = function getContextAwareComponent(context, originalComponent) {
  ...
  var ContextAwareComponent = function ContextAwareComponent(props) {
    return /*#__PURE__*/React__default.createElement(Context.Consumer, null, function (c) {
      return /*#__PURE__*/React__default.createElement(OriginalComponent, _extends({}, c, props));
    });
  };
...
var AutoCompleteInput = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function AutoCompleteInput(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "startTracking", function () {
      ...
      _this.props.openSuggestions(title, component);
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "updateSuggestions", /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return triggers[_this.state.currentTrigger].dataProvider(q, _this.props.value, function (data, query) {
                  // Make sure that the result is still relevant for current query
                  if (_this.state.currentTokenForSuggestions !== query) {
                    return;
                  }

                  _this.props.updateSuggestions({
                    data: data,
                    onSelect: _this.onSelectSuggestion
                  });
                });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSelectionChange", function (_ref3) {
      var _ref3$nativeEvent$sel = _ref3.nativeEvent.selection,
          start = _ref3$nativeEvent$sel.start,
          end = _ref3$nativeEvent$sel.end;
    ...
    _defineProperty(_assertThisInitialized(_this), "syncCaretPosition", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
      var position,
          _args2 = arguments;
      return _regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              position = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : 0;
              _context2.next = 3;
    ...
    _defineProperty(_assertThisInitialized(_this), "isCommand", function (text) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleCommand", function (text) {
      if (!_this.isCommand(text)) {
        return false;
      }
      ...
      _this.setState({
        ...
        if (!_this.isTrackingStarted) _this.startTracking();
        var actualToken = text.trim().slice(1);
        return _this.updateSuggestions(actualToken);
      });

      return true;
    });

    _defineProperty(_assertThisInitialized(_this), "handleMentions", function (text) {
      var selectionEnd = _this.state.selectionEnd; // TODO: Move these const to props

      var minChar = 0;
      var tokenMatch = text.slice(0, selectionEnd).match(/(?!^|\W)?[:@][^\s]*\s?[^\s]*$/g);
      var lastToken = tokenMatch && tokenMatch[tokenMatch.length - 1].trim();
      var triggers = _this.props.triggerSettings;
      var currentTrigger = lastToken && Object.keys(triggers).find(function (a) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSuggestions", function (text) {
      ...
      setTimeout(function () {
        ...
        if (text.slice(selectionEnd - 1, selectionEnd) === ' ' && !_this.state.isTrackingStarted) {
          _this.stopTracking();

          return;
        }

        if (_this.handleCommand(text)) return;

        _this.handleMentions(text);
      }, 100);
    });
  ...
  _createClass(AutoCompleteInput, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(InputBox, _extends({
...
var themed = function themed(OriginalComponent) {
  ...
  var ThemedComponent = function ThemedComponent(_ref) {
    ...
    return /*#__PURE__*/React__default.createElement(styled.ThemeConsumer, null, function (themeProviderTheme) {
      if (!style && themeProviderTheme) {
        return /*#__PURE__*/React__default.createElement(OriginalComponent, props);
      }
      ...
      return /*#__PURE__*/React__default.createElement(styled.ThemeProvider, {
        theme: modifiedTheme
      }, /*#__PURE__*/React__default.createElement(OriginalComponent, props));
    });
  };
...
var Avatar = themed((_temp = _class = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$1(Avatar);
  ...
  _createClass(Avatar, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(AvatarContainer, null, image && !this.state.imageError ? /*#__PURE__*/React__default.createElement(AvatarImage, {
        size: size,
        source: {
          uri: image
        },
      ...
      }) : /*#__PURE__*/React__default.createElement(AvatarFallback, {
        size: size
      }, /*#__PURE__*/React__default.createElement(AvatarText, {
        fontSize: fontSize
      }, initials)));
    }
  }]);
...
var MentionsItem = themed((_temp$1 = _class$1 = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = _createSuper$2(MentionsItem);
  ...
  _createClass(MentionsItem, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(Container, null, /*#__PURE__*/React__default.createElement(Avatar, {
        image: image,
        name: name
      }), /*#__PURE__*/React__default.createElement(Name, null, name || id));
    }
  }]);
...
var CommandArgs = styled__default.Text(_templateObject4$1(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.messageInput.suggestions.command.args.css;
});
var CommandDescription = styled__default.Text(_templateObject5(), function (_ref5) {
  var theme = _ref5.theme;
...
var CommandsItem = themed((_temp$2 = _class$2 = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = _createSuper$3(CommandsItem);
  ...
  _createClass(CommandsItem, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(Container$1, null, /*#__PURE__*/React__default.createElement(Top, null, /*#__PURE__*/React__default.createElement(Title, null, "/", name, " "), /*#__PURE__*/React__default.createElement(CommandArgs, null, args)), /*#__PURE__*/React__default.createElement(CommandDescription, null, description));
    }
  }]);
...
function _createForOfIteratorHelper(o, allowArrayLike) { var it$$1; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it$$1 = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it$$1) o = it$$1; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it$$1 = o[Symbol.iterator](); }, n: function n() { var step = it$$1.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it$$1["return"] != null) it$$1["return"](); } finally { if (didErr) throw err; } } }; }

function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }

function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
var renderText = function renderText(message, styles, markdownRules) {
  ...
  var markdownStyles = _objectSpread$1(_objectSpread$1({}, defaultMarkdownStyles), styles);

  return /*#__PURE__*/React__default.createElement(Markdown, {
    rules: markdownRules,
...
var renderReactions = function renderReactions(reactions, supportedReactions) {
  ...
  return Object.keys(reactionsByType).map(function (type) {
    return reactionTypes.indexOf(type) > -1 ? /*#__PURE__*/React__default.createElement(reactNative.Text, {
      key: type
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return this.i18nInstance.init(_objectSpread$2(_objectSpread$2({}, this.i18nextConfig), {}, {
    ...
    value: function addOrUpdateLocale(key, config) {
      if (this.localeExists(key)) {
        ...
        Dayjs.locale(_objectSpread$2({
          name: key
        }, _objectSpread$2(_objectSpread$2({}, en_locale), config)), null, true);
      }
    }
    /**
...
function _createForOfIteratorHelper$1(o, allowArrayLike) { var it$$1; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it$$1 = _unsupportedIterableToArray$1(o)) || allowArrayLike && o && typeof o.length === "number") { if (it$$1) o = it$$1; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it$$1 = o[Symbol.iterator](); }, n: function n() { var step = it$$1.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it$$1["return"] != null) it$$1["return"](); } finally { if (didErr) throw err; } } }; }
...
var getWatchers = function getWatchers(channel) {
  ...
  if (watchers && Object.values(watchers).length) {
    result.push.apply(result, _toConsumableArray(Object.values(watchers)));
  }
...
var getMembersAndWatchers = function getMembersAndWatchers(channel) {
  var users = [].concat(_toConsumableArray(getMembers(channel)), _toConsumableArray(getWatchers(channel))); // make sure we don't list users twice
...
var queryMembers = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(channel, query, onReady) {
    var response, users;
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var queryMembersDebounced = debounce(queryMembers, 200, {
  trailing: true,
  leading: false
  ...
  return {
    '@': {
      dataProvider: function dataProvider(query, text, onReady) {
        var members = channel.state.members; // By default, we return maximum 100 members via queryChannels api call.
        // Thus it is safe to assume, that if number of members in channel.state is < 100,
        // then all the members are already available on client side and we don't need to
        // make any api call to queryMembers endpoint.

        if (!query || Object.values(members).length < 100) {
          var users = getMembersAndWatchers(channel);
          var matchingUsers = users.filter(function (user) {
            if (!query) return true;

            if (user.name !== undefined && user.name.toLowerCase().indexOf(query.toLowerCase()) !== -1) {
              return true;
            } else if (user.id.toLowerCase().indexOf(query.toLowerCase()) !== -1) {
              return true;
            } else {
              return false;
            }
    ...
    '/': {
      dataProvider: function dataProvider(q, text, onReady) {
        ...
        var selectedCommands = getCommands(channel).filter(function (c) {
...
var CardCover = styled__default.Image(_templateObject2$3(), function (_ref5) {
  var theme = _ref5.theme;
  return theme.message.card.cover.css;
});
var CardFooter = styled__default.View(_templateObject3$2(), function (_ref6) {
  var theme = _ref6.theme;
  return theme.message.card.footer.css;
});
var FooterTitle = styled__default.Text(_templateObject4$2(), function (_ref7) {
  var theme = _ref7.theme;
  return theme.message.card.footer.title.css;
});
var FooterDescription = styled__default.Text(_templateObject5$1(), function (_ref8) {
  var theme = _ref8.theme;
  return theme.message.card.footer.description.css;
});
var FooterLink = styled__default.Text(_templateObject6(), function (_ref9) {
  var theme = _ref9.theme;
  return theme.message.card.footer.link.css;
});
var FooterLogo = styled__default.Image(_templateObject7(), function (_ref10) {
  var theme = _ref10.theme;
...
var Card = withMessageContentContext(themed((_temp$3 = _class$3 = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = _createSuper$4(Card);
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(Container$2, _extends({
        onPress: function onPress() {
          _this2._goToURL(og_scrape_url || image_url || thumb_url);
        },
        onLongPress: onLongPress,
        alignment: alignment
      }, additionalTouchableProps), Header && /*#__PURE__*/React__default.createElement(Header, this.props), Cover && /*#__PURE__*/React__default.createElement(Cover, this.props), uri && !Cover && /*#__PURE__*/React__default.createElement(CardCover, {
        source: {
          uri: uri
        },
        resizeMode: "cover"
      }), Footer ? /*#__PURE__*/React__default.createElement(Footer, this.props) : /*#__PURE__*/React__default.createElement(CardFooter, null, /*#__PURE__*/React__default.createElement(reactNative.View, {
        style: {
          display: 'flex',
          flexDirection: 'column',
          backgroundColor: 'transparent'
        }
      }, title && /*#__PURE__*/React__default.createElement(FooterTitle, null, title), text && /*#__PURE__*/React__default.createElement(FooterDescription, null, text), /*#__PURE__*/React__default.createElement(FooterLink, null, this.trimUrl(title_link || og_scrape_url))), type === 'giphy' && /*#__PURE__*/React__default.createElement(FooterLogo, {
        source: img
      })));
    }
  }]);
...
var _Date = styled__default.Text(_templateObject4$3(), function (_ref5) {
  var theme = _ref5.theme;
...
var DateSeparator = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$5(DateSeparator);
  ...
  _createClass(DateSeparator, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(Container$3, null, /*#__PURE__*/React__default.createElement(Line, null), /*#__PURE__*/React__default.createElement(DateText, null, formatDate ? formatDate(message.date) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(_Date, null, tDateTimeParser(message.date).calendar()))), /*#__PURE__*/React__default.createElement(Line, null));
    }
  }]);
...
var EmptyStateIndicator = function EmptyStateIndicator(_ref) {
  ...
  switch (listType) {
    case 'channel':
      Indicator = /*#__PURE__*/React__default.createElement(reactNative.Text, null, "You have no channels currently");
      break;
    ...
    default:
      Indicator = /*#__PURE__*/React__default.createElement(reactNative.Text, null, "No items exist");
      break;
  }
...
var Date$1 = styled__default.Text(_templateObject$6(), function (_ref) {
  var theme = _ref.theme;
...
var MemberUpdateText = styled__default.Text(_templateObject4$4(), function (_ref4) {
  var theme = _ref4.theme;
...
var EventIndicator = function EventIndicator(_ref5) {
  ...
  if (event.type === 'member.added' || event.type === 'member.removed') {
    return /*#__PURE__*/React__default.createElement(MemberUpdateContainer, null, /*#__PURE__*/React__default.createElement(Avatar, {
      name: event.user.name,
      image: event.user.image
    }), /*#__PURE__*/React__default.createElement(MemberUpdateTextContainer, null, /*#__PURE__*/React__default.createElement(MemberUpdateText, null, event.type === 'member.added' ? t('{{ username }} joined the chat', {
      username: event.user.name
    }) : t('{{ username }} was removed from the chat', {
      username: event.user.name
    })), /*#__PURE__*/React__default.createElement(Date$1, null, tDateTimeParser(event.received_at).format('LT'))));
  }
...
var Icon = styled__default.Image(_templateObject$7(), function (_ref) {
  var theme = _ref.theme;
...
var FileIcon = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = _createSuper$6(FileIcon);
...
var Container$4 = styled__default.View(_templateObject$8(), function (_ref) {
  var theme = _ref.theme;
...
var Button = styled__default(function (_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(reactNative.TouchableOpacity, rest);
...
var ButtonText = styled__default(function (_ref6) {
  ...
  return /*#__PURE__*/React__default.createElement(reactNative.Text, rest);
...
var AttachmentActions = themed((_temp$4 = _class$4 = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$7(AttachmentActions);
  ...
  _createClass(AttachmentActions, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(Container$4, null, actions.map(function (action) {
...
var Container$5 = styled__default.View(_templateObject$9(), function (_ref) {
  var theme = _ref.theme;
...
var CloseButton = themed((_temp$5 = _class$5 = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$8(CloseButton);
  ...
  _createClass(CloseButton, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/React__default.createElement(Container$5, null, /*#__PURE__*/React__default.createElement(reactNative.Image, {
        source: img$6
      }));
    }
  }]);
...
var Single = styled__default.TouchableOpacity(_templateObject$a(), function (_ref) {
  var theme = _ref.theme;
...
var Gallery = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Gallery, [{
    ...
    value: function render() {
      ...
      if (images.length === 1) {
        return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Single, _extends({
          onPress: function onPress() {
            _this2.setState({
        ...
        }, additionalTouchableProps), /*#__PURE__*/React__default.createElement(reactNative.Image, {
          style: {
            width: 100 + '%',
            height: 100 + '%'
          },
        ...
        }, /*#__PURE__*/React__default.createElement(reactNative.SafeAreaView, {
          style: {
            flex: 1,
            backgroundColor: 'transparent'
          }
          ...
          renderHeader: function renderHeader() {
            return /*#__PURE__*/React__default.createElement(GalleryHeader, {
      ...
      return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(GalleryContainer, {
        length: images.length,
        alignment: this.props.alignment
      }, images.slice(0, 4).map(function (image, i) {
        return /*#__PURE__*/React__default.createElement(ImageContainer, _extends({
        ...
        }, additionalTouchableProps), i === 3 && images.length > 4 ? /*#__PURE__*/React__default.createElement(reactNative.View, {
          style: {
            width: '100%',
            height: '100%'
          }
...
var HeaderContainer = styled__default.View(_templateObject4$5(), function (_ref13) {
  var theme = _ref13.theme;
  return theme.message.gallery.header.container.css;
});
var HeaderButton = styled__default.TouchableOpacity(_templateObject5$2(), function (_ref14) {
...
var GalleryHeader = function GalleryHeader(_ref15) {
  ...
  return /*#__PURE__*/React__default.createElement(HeaderContainer, null, /*#__PURE__*/React__default.createElement(HeaderButton, {
    onPress: handleDismiss
  }, /*#__PURE__*/React__default.createElement(CloseButton, null)));
};
...
var FileContainer = styled__default.View(_templateObject$b(), function (_ref) {
...
var FileSize = styled__default.Text(_templateObject4$6(), function (_ref7) {
  var theme = _ref7.theme;
...
var FileAttachment = withMessageContentContext(function (_ref8) {
  ...
  return /*#__PURE__*/React__default.createElement(reactNative.TouchableOpacity, _extends({
    onPress: function onPress() {
      goToURL(attachment.asset_url);
    },
    onLongPress: onLongPress
  }, additionalTouchableProps), /*#__PURE__*/React__default.createElement(FileContainer, {
    alignment: alignment,
    groupStyle: groupStyle
  }, /*#__PURE__*/React__default.createElement(AttachmentFileIcon, {
    filename: attachment.title,
    mimeType: attachment.mime_type
  }), /*#__PURE__*/React__default.createElement(FileDetails, null, /*#__PURE__*/React__default.createElement(FileTitle, {
    ellipsizeMode: "tail",
    numberOfLines: 2
  }, attachment.title), /*#__PURE__*/React__default.createElement(FileSize, null, attachment.file_size, " KB"))), attachment.actions && attachment.actions.length > 0 && /*#__PURE__*/React__default.createElement(AttachmentActions, _extends({
...
var Attachment = withMessageContentContext(themed((_temp$6 = _class$6 = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Attachment, [{
    ...
    value: function render() {
      ...
      if (type === 'image') {
        return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Gallery, {
          alignment: this.props.alignment,
          images: [a]
        }), a.actions && a.actions.length > 0 && /*#__PURE__*/React__default.createElement(AttachmentActions$$1, _extends({
      ...
      if (type === 'giphy') {
        if (a.actions && a.actions.length) {
          return /*#__PURE__*/React__default.createElement(reactNative.View, null, /*#__PURE__*/React__default.createElement(Giphy, _extends({}, a, {
            alignment: this.props.alignment
          }, cardProps)), a.actions && a.actions.length > 0 && /*#__PURE__*/React__default.createElement(AttachmentActions$$1, _extends({
            key: 'key-actions-' + a.id
          }, a, {
            actionHandler: this.props.actionHandler
          })));
        } else {
          return /*#__PURE__*/React__default.createElement(Giphy, _extends({
            alignment: this.props.alignment
          }, a, cardProps));
        }
      }
      ...
      if (type === 'card') {
        if (a.actions && a.actions.length) {
          return /*#__PURE__*/React__default.createElement(reactNative.View, null, /*#__PURE__*/React__default.createElement(Card$$1, _extends({}, a, {
            alignment: this.props.alignment
          }, cardProps)), a.actions && a.actions.length > 0 && /*#__PURE__*/React__default.createElement(AttachmentActions$$1, _extends({
            key: 'key-actions-' + a.id
          }, a, {
      ...
      if (type === 'urlPreview') {
        return /*#__PURE__*/React__default.createElement(UrlPreview, _extends({
          alignment: this.props.alignment
        }, a, cardProps));
      }
      ...
      if (type === 'file') {
        ...
        return /*#__PURE__*/React__default.createElement(FileAttachment$$1, {
          attachment: a,
          actionHandler: actionHandler,
...
var FileAttachmentGroup = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(FileAttachmentGroup, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(Container$6, null, files && files.map(function (file, index, files) {
        var groupStyle;
...
var Overlay = styled__default.View(_templateObject$d(), function (_ref) {
  var theme = _ref.theme;
...
var UploadProgressIndicator = themed((_temp$7 = _class$7 = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$c(UploadProgressIndicator);
  ...
  _createClass(UploadProgressIndicator, [{
    ...
    value: function render() {
      ...
      }, children, /*#__PURE__*/React__default.createElement(Overlay, null), /*#__PURE__*/React__default.createElement(Container$7, null, type === ProgressIndicatorTypes.IN_PROGRESS && /*#__PURE__*/React__default.createElement(reactNative.View, {
        style: {
          position: 'absolute',
          top: 0,
          left: 0,
      ...
      }, /*#__PURE__*/React__default.createElement(reactNative.ActivityIndicator, {
        style: {},
        color: "white"
      })), type === ProgressIndicatorTypes.RETRY && /*#__PURE__*/React__default.createElement(reactNative.Image, {
        source: img$7,
        style: {
          height: 18,
          width: 18
...
var FileUploadPreview = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$d(FileUploadPreview);
  ...
  function FileUploadPreview(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_renderItem", function (_ref) {
      ...
      return /*#__PURE__*/React__default.createElement(UploadProgressIndicator, {
      ...
      }, item.file.name.length > 35 ? item.file.name.substring(0, 35).concat('...') : item.file.name)), /*#__PURE__*/React__default.createElement(reactNative.Text, {
  ...
  _createClass(FileUploadPreview, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React__default.createElement(reactNative.FlatList, {
        style: {
          flex: 1
        },
...
var StyledTouchableOpacity = styled__default.TouchableOpacity(_templateObject$e(), function (_ref) {
  var theme = _ref.theme;
  return theme.iconSquare.container.css;
});
var StyledView = styled__default.View(_templateObject2$a(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.iconSquare.container.css;
});
var IconSquare = function IconSquare(_ref3) {
  ...
  if (onPress) return /*#__PURE__*/React__default.createElement(StyledTouchableOpacity, {
    onPress: onPress
  }, /*#__PURE__*/React__default.createElement(reactNative.Image, {
    source: icon,
    style: {
  ...
  }));else return /*#__PURE__*/React__default.createElement(StyledView, null, /*#__PURE__*/React__default.createElement(reactNative.Image, {
    source: icon,
    style: {
      height: 15,
      width: 15
...
var Container$8 = styled__default.View(_templateObject$f(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageInput.imageUploadPreview.container.css;
});
var ItemContainer = styled__default.View(_templateObject2$b(), function (_ref2) {
  var theme = _ref2.theme;
...
var Upload = styled__default.Image(_templateObject4$7(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.messageInput.imageUploadPreview.upload.css;
});
var DismissImage = styled__default.Image(_templateObject5$3(), function (_ref5) {
  var theme = _ref5.theme;
...
var ImageUploadPreview = themed((_temp$8 = _class$8 = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$e(ImageUploadPreview);
  ...
  function ImageUploadPreview(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_renderItem", function (_ref6) {
      ...
      if (item.state === FileState.UPLOADING) type = ProgressIndicatorTypes.IN_PROGRESS;
      if (item.state === FileState.UPLOAD_FAILED) type = ProgressIndicatorTypes.RETRY;
      return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(ItemContainer, null, /*#__PURE__*/React__default.createElement(UploadProgressIndicator, {
        active: item.state !== FileState.UPLOADED,
        type: type,
      ...
      }, /*#__PURE__*/React__default.createElement(DismissImage, {
        source: img$6
      }))));
    });
  ...
  _createClass(ImageUploadPreview, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(Container$8, null, /*#__PURE__*/React__default.createElement(reactNative.FlatList, {
        horizontal: true,
        style: {
          flex: 1
        },
...
var KeyboardCompatibleView = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$f(KeyboardCompatibleView);
  ...
  function KeyboardCompatibleView(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setupListeners", function () {
      reactNative.AppState.addEventListener('change', _this._handleAppStateChange);

      _this.setupKeyboardListeners();
    });

    _defineProperty(_assertThisInitialized(_this), "removeListeners", function () {
      reactNative.AppState.removeEventListener('change', _this._handleAppStateChange);

      _this.removeKeyboardListeners();
    });

    _defineProperty(_assertThisInitialized(_this), "setupKeyboardListeners", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "removeKeyboardListeners", function () {
    ...
    _this.state = {
      channelHeight: new reactNative.Animated.Value(0),
      ...
      key: 0,
      appState: reactNative.AppState.currentState
    };
  ...
  _createClass(KeyboardCompatibleView, [{
    ...
    value: function render() {
      ...
      if (!this.props.enabled) {
        return /*#__PURE__*/React__default.createElement(KeyboardContext.Provider, {
          value: this.getContext()
        }, this.props.children);
      }

      return /*#__PURE__*/React__default.createElement(reactNative.Animated.View, animatedViewProps, /*#__PURE__*/React__default.createElement(KeyboardContext.Provider, {
        value: this.getContext()
      }, /*#__PURE__*/React__default.createElement(reactNative.View, {
...
var Container$9 = styled__default.TouchableOpacity(_templateObject$g(), function (_ref) {
  var theme = _ref.theme;
  return theme.loadingErrorIndicator.container.css;
});
var ErrorText = styled__default.Text(_templateObject2$c(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.loadingErrorIndicator.errorText.css;
});
var RetryText = styled__default.Text(_templateObject3$9(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.loadingErrorIndicator.retryText.css;
});

var LoadingErrorIndicator = function LoadingErrorIndicator(_ref4) {
  var listType = _ref4.listType,
      retry = _ref4.retry,
      t = _ref4.t;
  var Loader;
  ...
  switch (listType) {
    case 'channel':
      Loader = /*#__PURE__*/React__default.createElement(Container$9, {
        onPress: function onPress() {
          retry && retry();
        }
      }, /*#__PURE__*/React__default.createElement(ErrorText, null, t('Error loading channel list ...')), /*#__PURE__*/React__default.createElement(RetryText, null, "\u27F3"));
      break;

    case 'message':
      Loader = /*#__PURE__*/React__default.createElement(Container$9, null, /*#__PURE__*/React__default.createElement(ErrorText, null, t('Error loading messages for this channel ...')));
      break;

    default:
      Loader = /*#__PURE__*/React__default.createElement(Container$9, null, /*#__PURE__*/React__default.createElement(ErrorText, null, t('Error loading')));
      break;
  }
...
var Circle = styled__default(AnimatedView)(_templateObject$h(), function (_ref) {
  var theme = _ref.theme;
  return theme.colors.primary;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var Spinner = themed((_temp$9 = _class$9 = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$g(Spinner);
...
var Container$a = styled__default.View(_templateObject$i(), function (_ref) {
  var theme = _ref.theme;
  return theme.loadingIndicator.container.css;
});
var LoadingText = styled__default.Text(_templateObject2$d(), function (_ref2) {
  var theme = _ref2.theme;
...
var LoadingIndicator = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$h(LoadingIndicator);
  ...
  _createClass(LoadingIndicator, [{
    ...
    value: function render() {
      ...
      switch (listType) {
        case 'channel':
          return /*#__PURE__*/React__default.createElement(Container$a, null, /*#__PURE__*/React__default.createElement(Spinner, null), /*#__PURE__*/React__default.createElement(LoadingText, null, loadingText ? loadingText : t('Loading channels ...')));

        case 'message':
          return /*#__PURE__*/React__default.createElement(Container$a, null, /*#__PURE__*/React__default.createElement(Spinner, null), /*#__PURE__*/React__default.createElement(LoadingText, null, loadingText ? loadingText : t('Loading messages ...')));

        case 'default':
        default:
          return /*#__PURE__*/React__default.createElement(Container$a, null, /*#__PURE__*/React__default.createElement(Spinner, null), /*#__PURE__*/React__default.createElement(LoadingText, null, loadingText ? loadingText : t('Loading ...')));
      }
    }
  }]);
...
var Container$b = styled__default.View(_templateObject$j(), function (_ref) {
  var alignment = _ref.alignment;
...
var Spacer = styled__default.View(_templateObject2$e(), function (_ref4) {
  var theme = _ref4.theme;
...
var MessageAvatar = function MessageAvatar(_ref5) {
  ...
  return /*#__PURE__*/React__default.createElement(Container$b, {
    alignment: alignment
  }, visible ? /*#__PURE__*/React__default.createElement(Avatar, {
    image: message.user.image,
    name: message.user.name || message.user.id
  }) : /*#__PURE__*/React__default.createElement(Spacer, null));
};
...
var TouchableWrapper = styled__default.View(_templateObject$k(), function (_ref) {
  var alignment = _ref.alignment;
...
var Container$c = styled__default.View(_templateObject2$f(), function (_ref3) {
...
var ImageWrapper = styled__default.View(_templateObject4$8(), function (_ref8) {
  var visible = _ref8.visible;
  return visible ? 1 : 0;
});
var LeftTail = styled__default.Image(_templateObject5$4());
...
var ReactionList = themed((_temp$a = _class$a = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$i(ReactionList);
  ...
  _createClass(ReactionList, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(TouchableWrapper, {
        alignment: alignment,
        activeOpacity: 1
      }, /*#__PURE__*/React__default.createElement(Container$c, {
        visible: visible
      }, /*#__PURE__*/React__default.createElement(Reactions, null, renderReactions(latestReactions, supportedReactions)), /*#__PURE__*/React__default.createElement(ReactionCount, {
        reactionCounts: getTotalReactionCount(supportedReactions)
      }, getTotalReactionCount(supportedReactions))), /*#__PURE__*/React__default.createElement(ImageWrapper, {
        visible: visible
      }, alignment === 'left' ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(LeftTail, {
        source: img$8
      }), /*#__PURE__*/React__default.createElement(LeftCenter, {
        source: img$9,
        resizeMode: "stretch"
      }), /*#__PURE__*/React__default.createElement(LeftEnd, {
        source: img$a
      })) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(RightEnd, {
        source: img$d
      }), /*#__PURE__*/React__default.createElement(RightCenter, {
        source: img$c,
        resizeMode: "stretch"
      }), /*#__PURE__*/React__default.createElement(RightTail, {
        source: img$b
      }))));
    }
  }]);
...
var TextContainer = styled__default.View(_templateObject$l(), function (_ref) {
  var theme = _ref.theme,
...
var MessageTextContainer = styled.withTheme(function (props) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(TextContainer, {
    alignment: alignment,
    groupStyle: groupStyle,
    status: message.status,
    type: message.type
  }, !MessageText ? renderText(message, markdownStyles, markdownRules) : /*#__PURE__*/React__default.createElement(MessageText, _extends({}, props, {
...
var Container$d = styled__default.TouchableOpacity(_templateObject$m(), function (_ref) {
  var theme = _ref.theme;
  return theme.message.replies.container.css;
});
var MessageRepliesText = styled__default.Text(_templateObject2$g(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.colors.primary;
}, function (_ref3) {
  var theme = _ref3.theme;
...
var MessageReplies = function MessageReplies(_ref6) {
  ...
  return /*#__PURE__*/React__default.createElement(Container$d, {
    onPress: openThread
  }, alignment === 'left' ? /*#__PURE__*/React__default.createElement(MessageRepliesImage, {
    source: img$e,
    alignment: alignment
  }) : null, /*#__PURE__*/React__default.createElement(MessageRepliesText, null, message.reply_count === 1 ? t('1 reply') : t('{{ replyCount }} replies', {
    replyCount: message.reply_count
  })), alignment === 'right' ? /*#__PURE__*/React__default.createElement(MessageRepliesImage, {
    source: img$e,
    alignment: alignment
  }) : null);
};
...
var Container$e = styled__default.TouchableOpacity(_templateObject$n(), function (_ref) {
...
var ContainerView = styled__default.View(_templateObject2$h(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.message.reactionPicker.containerView.css;
});
var Column = styled__default.View(_templateObject3$c(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.message.reactionPicker.column.css;
});
var Emoji = styled__default.Text(_templateObject4$9(), function (_ref5) {
  var theme = _ref5.theme;
  return theme.message.reactionPicker.emoji.css;
});
var ReactionCount$1 = styled__default.Text(_templateObject5$5(), function (_ref6) {
  var theme = _ref6.theme;
...
var ReactionPicker = themed((_temp$b = _class$b = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$j(ReactionPicker);
  ...
  _createClass(ReactionPicker, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(reactNative.Modal, {
        visible: reactionPickerVisible,
        transparent: true,
        animationType: "fade",
        onShow: function onShow() {},
        onRequestClose: handleDismiss
      }, reactionPickerVisible && /*#__PURE__*/React__default.createElement(Container$e, {
        onPress: handleDismiss,
        leftAlign: Boolean(rpLeft),
        activeOpacity: 1
      }, /*#__PURE__*/React__default.createElement(ContainerView, {
        ...
        return /*#__PURE__*/React__default.createElement(Column, {
          key: id
        }, latestUser !== 'NotFound' && !hideReactionOwners ? /*#__PURE__*/React__default.createElement(Avatar, {
        ...
        }) : !hideReactionOwners && /*#__PURE__*/React__default.createElement(reactNative.View, {
          style: {
            height: 18,
            width: 18
          }
        ...
        }, icon), !hideReactionCount && /*#__PURE__*/React__default.createElement(ReactionCount$1, null, count > 0 ? count : ''));
      }))));
    }
  }]);
...
var ReactionPickerWrapper = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$k(ReactionPickerWrapper);
      ...
      if (_this.messageContainer) {
        _this.messageContainer.measureInWindow(function (x, y, width) {
          _this.setState({
            ...
            rpRight: alignment === 'right' ? Math.round(reactNative.Dimensions.get('window').width) - (x + width + offset.right) : null
          });
        });
      }
    });
  ...
  _createClass(ReactionPickerWrapper, [{
    ...
    value: function render() {
      ...
      }, this.props.children, /*#__PURE__*/React__default.createElement(ReactionPicker$$1, _extends({}, this.props, {
...
var Container$f = styled__default.TouchableOpacity(_templateObject$o(), function (_ref) {
...
var ContainerInner = styled__default.View(_templateObject2$i(), function (_ref10) {
...
var MetaText = styled__default.Text(_templateObject4$a(), function (_ref13) {
  var theme = _ref13.theme;
...
var DeletedContainer = styled__default.View(_templateObject5$6(), function (_ref16) {
...
var MessageContent = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$l(MessageContent);
  ...
  _createClass(MessageContent, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          t = _this$props.t,
          tDateTimeParser = _this$props.tDateTimeParser,
          markdownRules = _this$props.markdownRules;
      ...
      if (message.deleted_at) return /*#__PURE__*/React__default.createElement(DeletedContainer, {
        alignment: alignment
      }, /*#__PURE__*/React__default.createElement(DeletedText, null, t('This message was deleted ...')));
      ...
      return /*#__PURE__*/React__default.createElement(MessageContentContext.Provider, {
        value: context
      }, /*#__PURE__*/React__default.createElement(Container$f, _extends({}, contentProps, {
        error: message.type === 'error' || message.status === 'failed'
      }), message.type === 'error' ? /*#__PURE__*/React__default.createElement(FailedText, null, t('ERROR · UNSENT')) : null, message.status === 'failed' ? /*#__PURE__*/React__default.createElement(FailedText, null, t('Message failed - try again')) : null, reactionsEnabled && ReactionList$$1 && /*#__PURE__*/React__default.createElement(ReactionPickerWrapper, {
        reactionPickerVisible: reactionPickerVisible,
        handleReaction: handleReaction,
        hideReactionCount: hideReactionCount,
        hideReactionOwners: hideReactionOwners,
      ...
      }, message.latest_reactions && message.latest_reactions.length > 0 && /*#__PURE__*/React__default.createElement(ReactionList$$1, {
        alignment: alignment,
        visible: !reactionPickerVisible,
        latestReactions: message.latest_reactions,
        ...
        reactionCounts: message.reaction_counts,
        supportedReactions: supportedReactions
      })), MessageHeader && /*#__PURE__*/React__default.createElement(MessageHeader, this.props), /*#__PURE__*/React__default.createElement(ContainerInner, {
        alignment: alignment,
        ref: function ref(o) {
          return _this2.messageContainer = o;
        },
      ...
      }), files && files.length > 0 && /*#__PURE__*/React__default.createElement(FileAttachmentGroup$$1, {
        ...
        FileAttachment: FileAttachment$$1,
        AttachmentActions: AttachmentActions
      }), images && images.length > 0 && /*#__PURE__*/React__default.createElement(Gallery, {
        alignment: alignment,
        images: images
      }), /*#__PURE__*/React__default.createElement(MessageTextContainer, {
        message: message,
      ...
      })), repliesEnabled ? /*#__PURE__*/React__default.createElement(MessageReplies, {
        message: message,
        isThreadList: !!threadList,
        openThread: this.openThread,
        alignment: alignment,
        channel: channel
      }) : null, MessageFooter && /*#__PURE__*/React__default.createElement(MessageFooter, this.props), !MessageFooter && showTime ? /*#__PURE__*/React__default.createElement(MetaContainer, null, /*#__PURE__*/React__default.createElement(MetaText, {
        alignment: alignment
      }, this.props.formatDate ? this.props.formatDate(message.created_at) : tDateTimeParser(message.created_at).format('LT'))) : null, /*#__PURE__*/React__default.createElement(reactNativeActionsheet.ActionSheetCustom, {
        ref: function ref(o) {
          _this2.ActionSheet = o;
        },
        title: /*#__PURE__*/React__default.createElement(ActionSheetTitleContainer, null, /*#__PURE__*/React__default.createElement(ActionSheetTitleText, null, t('Choose an action'))),
        options: _toConsumableArray(options.map(function (o, i) {
          if (i === 0) {
            return /*#__PURE__*/React__default.createElement(ActionSheetCancelButtonContainer, null, /*#__PURE__*/React__default.createElement(ActionSheetCancelButtonText, null, t('Cancel')));
          }

          return /*#__PURE__*/React__default.createElement(ActionSheetButtonContainer, {
            key: o.title
          }, /*#__PURE__*/React__default.createElement(ActionSheetButtonText, null, o.title));
        })),
        cancelButtonIndex: 0,
...
var Spacer$1 = styled__default.View(_templateObject$p());
var StatusContainer = styled__default.View(_templateObject2$j());
var DeliveredContainer = styled__default.View(_templateObject3$e(), function (_ref) {
  var theme = _ref.theme;
  return theme.message.status.deliveredContainer.css;
});
var DeliveredCircle = styled__default.View(_templateObject4$b(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.colors.primary;
}, function (_ref3) {
  var theme = _ref3.theme;
...
var CheckMark = styled__default.Image(_templateObject5$7(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.message.status.checkMark.css;
});
var SendingContainer = styled__default.View(_templateObject6$3(), function (_ref5) {
  var theme = _ref5.theme;
  return theme.message.status.sendingContainer.css;
});
var SendingImage = styled__default.View(_templateObject7$3(), function (_ref6) {
  var theme = _ref6.theme;
...
var MessageStatus = function MessageStatus(_ref8) {
  ...
  var renderStatus = function renderStatus() {
    ...
    if (message.status === 'sending') {
      return /*#__PURE__*/React__default.createElement(SendingContainer, null, /*#__PURE__*/React__default.createElement(SendingImage, {
        source: img$f
      }));
      ...
      return /*#__PURE__*/React__default.createElement(ReadByContainer, null, /*#__PURE__*/React__default.createElement(Avatar, {
        name: lastReadUser.name || lastReadUser.id,
        image: lastReadUser.image,
        size: 16
      }));
    } else if (message.status === 'received' && message.type !== 'ephemeral' && message.id === lastReceivedId && !threadList) {
      return /*#__PURE__*/React__default.createElement(DeliveredContainer, null, /*#__PURE__*/React__default.createElement(DeliveredCircle, null, /*#__PURE__*/React__default.createElement(CheckMark, {
        source: img$g
      })));
    } else {
      return /*#__PURE__*/React__default.createElement(Spacer$1, null);
    }
  };

  return /*#__PURE__*/React__default.createElement(StatusContainer, null, renderStatus());
};
...
var Container$g = styled__default.View(_templateObject$q(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageList.messageSystem.container.css;
});
var Line$1 = styled__default.View(_templateObject2$k(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.colors.light;
}, function (_ref3) {
  var theme = _ref3.theme;
...
var TextContainer$1 = styled__default.View(_templateObject3$f(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.messageList.messageSystem.textContainer.css;
});
var Text = styled__default.Text(_templateObject4$c(), function (_ref5) {
  var theme = _ref5.theme;
  return theme.messageList.messageSystem.text.css;
});
var DateText$1 = styled__default.Text(_templateObject5$8(), function (_ref6) {
  var theme = _ref6.theme;
...
var MessageSystem = function MessageSystem(_ref7) {
  ...
  return /*#__PURE__*/React__default.createElement(Container$g, null, /*#__PURE__*/React__default.createElement(Line$1, null), /*#__PURE__*/React__default.createElement(TextContainer$1, null, /*#__PURE__*/React__default.createElement(Text, null, message.text.toUpperCase()), /*#__PURE__*/React__default.createElement(DateText$1, null, tDateTimeParser(message.created_at).calendar().toUpperCase())), /*#__PURE__*/React__default.createElement(Line$1, null));
};
...
var Container$h = styled__default.View(_templateObject$r(), function (_ref) {
  var alignment = _ref.alignment;
  return alignment === 'left' ? 'flex-start' : 'flex-end';
}, function (_ref2) {
...
var MessageSimple = themed((_temp$c = _class$c = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$m(MessageSimple);
  ...
  function MessageSimple(props) {
    ...
    _this = _super.call(this, props); // State reactionPickerVisible has been lifeted up in MessageSimple component
  ...
  _createClass(MessageSimple, [{
    ...
    value: function render() {
      ...
      if (message.type === 'system') {
        ...
        }, /*#__PURE__*/React__default.createElement(MessageSystem$$1, {
          message: message
        }));
      }
      ...
      var forwardedProps = _objectSpread$6(_objectSpread$6({}, this.props), {}, {
      ...
      return /*#__PURE__*/React__default.createElement(Container$h, {
        ...
        hasMarginBottom: hasMarginBottom,
        isVeryLastMessage: isVeryLastMessage
      }, alignment === 'right' ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(MessageContent$$1, forwardedProps), /*#__PURE__*/React__default.createElement(MessageAvatar$$1, forwardedProps), showMessageStatus && /*#__PURE__*/React__default.createElement(MessageStatus$$1, forwardedProps)) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(MessageAvatar$$1, forwardedProps), /*#__PURE__*/React__default.createElement(MessageContent$$1, forwardedProps)));
    }
  }]);
...
function _createForOfIteratorHelper$2(o, allowArrayLike) { var it$$1; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it$$1 = _unsupportedIterableToArray$2(o)) || allowArrayLike && o && typeof o.length === "number") { if (it$$1) o = it$$1; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it$$1 = o[Symbol.iterator](); }, n: function n() { var step = it$$1.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it$$1["return"] != null) it$$1["return"](); } finally { if (didErr) throw err; } } }; }
  ...
  function Message(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleReaction", /*#__PURE__*/function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(reactionType, event) {
        var userExistingReaction, currentUser, _iterator, _step, _reaction, originalMessage, reactionChangePromise, messageID, tmpReaction, reaction;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _iterator = _createForOfIteratorHelper$2(_this.props.message.own_reactions);
  ...
  _createClass(Message, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(reactNative.TouchableOpacity, {
        ...
        activeOpacity: 1
      }, /*#__PURE__*/React__default.createElement(Component, _extends({}, this.props, actionProps, {
...
var Container$i = styled__default.TouchableOpacity(_templateObject$s(), function (_ref) {
  var theme = _ref.theme;
  return theme.colors.primary;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var MessageNotificationText = styled__default.Text(_templateObject2$l(), function (_ref3) {
  var theme = _ref3.theme;
...
var MessageNotification = /*#__PURE__*/function (_PureComponent) {
  ...
  var _super = _createSuper$o(MessageNotification);
  ...
  _createClass(MessageNotification, [{
    ...
    value: function render() {
      ...
      if (!this.props.showNotification) {
        ...
        }, /*#__PURE__*/React__default.createElement(Container$i, {
          onPress: this.props.onPress
        }, /*#__PURE__*/React__default.createElement(MessageNotificationText, null, t('New Messages'))));
      }
    }
  }]);
...
var Wrapper = styled__default.TouchableOpacity(_templateObject$t(), function (_ref) {
...
var Container$j = styled__default.View(_templateObject2$m(), function (_ref3) {
...
var Title$1 = styled__default.Text(_templateObject3$g(), function (_ref7) {
  var theme = _ref7.theme;
...
var Separator = styled__default.View(_templateObject4$d(), function (_ref9) {
  var theme = _ref9.theme;
  return theme.messageInput.suggestions.separator.css;
});
var SuggestionsItem = styled__default.TouchableOpacity(_templateObject5$9(), function (_ref10) {
  var theme = _ref10.theme;
  return theme.messageInput.suggestions.container.itemHeight;
}, function (_ref11) {
  var theme = _ref11.theme;
...
var SuggestionsProvider = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$p(SuggestionsProvider);
  ...
  function SuggestionsProvider(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "openSuggestions", /*#__PURE__*/function () {
      var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(title, component) {
        var _yield$Promise$all, _yield$Promise$all2, inputBoxPosition, chatBoxPosition;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                inputBoxPosition = _yield$Promise$all2[0];
                chatBoxPosition = _yield$Promise$all2[1];
    ...
    _defineProperty(_assertThisInitialized(_this), "updateSuggestions", function (suggestions) {
      _this.setState({
        ...
        suggestionsViewActive: !!_this.state.component
      });
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "dismissSuggestionsList", function () {
      _this.setState({
        suggestionsViewActive: false
      });
    });
  ...
  _createClass(SuggestionsProvider, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/React__default.createElement(SuggestionsContext.Provider, {
        value: this.getContext()
      }, /*#__PURE__*/React__default.createElement(SuggestionsView, {
...
var SuggestionsView = /*#__PURE__*/function (_React$PureComponent2) {
  ...
  var _super2 = _createSuper$p(SuggestionsView);
  ...
  function SuggestionsView(props) {
    ...
    _defineProperty(_assertThisInitialized(_this2), "renderHeader", function () {
      return /*#__PURE__*/React__default.createElement(SuggestionsHeader, null);
    });

    _defineProperty(_assertThisInitialized(_this2), "renderItem", function (_ref13) {
      var item = _ref13.item;
      var _this2$props = _this2.props,
          onSelect = _this2$props.suggestions.onSelect,
          Component = _this2$props.component;
      return /*#__PURE__*/React__default.createElement(SuggestionsItem, {
        onPress: function onPress() {
          onSelect(item);
        }
  ...
  _createClass(SuggestionsView, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(Wrapper, {
        ...
        ListHeaderComponent: /*#__PURE__*/React__default.createElement(SuggestionsHeader, {
...
var SuggestionsHeader = function SuggestionsHeader(_ref14) {
  var title = _ref14.title;
  return /*#__PURE__*/React__default.createElement(Title$1, null, title);
};

var SuggestionsSeparator = function SuggestionsSeparator() {
  return /*#__PURE__*/React__default.createElement(Separator, null);
};
...
var Chat = themed((_temp$e = _class$e = /*#__PURE__*/function (_PureComponent) {
  ...
  var _super = _createSuper$q(Chat);
        ...
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                _yield$streami18n$get = _context.sent;
  ...
  return Chat;
}(React.PureComponent), _defineProperty(_class$e, "themePath", ''), _defineProperty(_class$e, "propTypes", {
...
var ChannelInner = /*#__PURE__*/function (_PureComponent) {
  ...
  var _super = _createSuper$r(ChannelInner);
  ...
  function ChannelInner(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "addToEventHistory", function (e) {
      _this.setState(function (prevState) {
        ...
        if (!prevState.eventHistory[lastMessageId]) return _objectSpread$7(_objectSpread$7({}, prevState), {}, {
          eventHistory: _objectSpread$7(_objectSpread$7({}, prevState.eventHistory), {}, _defineProperty({}, lastMessageId, [e]))
        });
        return _objectSpread$7(_objectSpread$7({}, prevState), {}, {
          eventHistory: _objectSpread$7(_objectSpread$7({}, prevState.eventHistory), {}, _defineProperty({}, lastMessageId, [].concat(_toConsumableArray(prevState.eventHistory[lastMessageId]), [e])))
        });
      });
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "getContext", function () {
      return _objectSpread$7(_objectSpread$7({}, _this.state), {}, {
        client: _this.props.client,
        channel: _this.props.channel,
        Message: _this.props.Message,
  ...
  _createClass(ChannelInner, [{
    ...
    value: function render() {
      ...
      if (this.state.error) {
        ...
        core = /*#__PURE__*/React__default.createElement(reactNative.View, null, /*#__PURE__*/React__default.createElement(reactNative.Text, null, t('Channel Missing')));
      } else {
        core = /*#__PURE__*/React__default.createElement(KeyboardCompatibleView, {
          enabled: !this.props.disableKeyboardCompatibleView
        }, /*#__PURE__*/React__default.createElement(ChannelContext.Provider, {
          value: this.getContext()
        }, /*#__PURE__*/React__default.createElement(SuggestionsProvider, null, children)));
      }
...
var Channel = /*#__PURE__*/function (_PureComponent) {
  ...
  var _super = _createSuper$s(Channel);
  ...
  _createClass(Channel, [{
    ...
    value: function render() {
      ...
      if (!this.props.channel.cid) {
        return /*#__PURE__*/React__default.createElement(reactNative.Text, null, t('Please select a channel first'));
      }

      return /*#__PURE__*/React__default.createElement(ChannelInnerWithContext, this.props);
    }
  }]);
...
var TypingText = styled__default.Text(_templateObject$u(), function (_ref) {
  var theme = _ref.theme;
...
var Container$k = styled__default.View(_templateObject2$n(), function (_ref4) {
  var theme = _ref4.theme;
...
var TypingIndicator = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$t(TypingIndicator);
  ...
  _createClass(TypingIndicator, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(Container$k, null, typingUsers.filter(function (_ref5) {
        var user = _ref5.user;
      ...
      }), /*#__PURE__*/React__default.createElement(TypingText, null, this.constructTypingString(typing)));
    }
  }]);
...
_defineProperty(TypingIndicator, "propTypes", {
  ...
  client: PropTypes.instanceOf(streamChat.StreamChat),
...
function _createForOfIteratorHelper$3(o, allowArrayLike) { var it$$1; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it$$1 = _unsupportedIterableToArray$3(o)) || allowArrayLike && o && typeof o.length === "number") { if (it$$1) o = it$$1; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it$$1 = o[Symbol.iterator](); }, n: function n() { var step = it$$1.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it$$1["return"] != null) it$$1["return"](); } finally { if (didErr) throw err; } } }; }
...
var ListContainer = styled__default.FlatList(_templateObject$v(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageList.listContainer.css;
});
var ErrorNotificationText = styled__default.Text(_templateObject2$o(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.messageList.errorNotificationText.css;
});
var ErrorNotification = styled__default.View(_templateObject3$h(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.messageList.errorNotification.css;
});
var TypingIndicatorContainer = styled__default.View(_templateObject4$e(), function (_ref4) {
  var theme = _ref4.theme;
...
var MessageList = /*#__PURE__*/function (_PureComponent) {
  ...
  var _super = _createSuper$u(MessageList);
  ...
  function MessageList(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "insertDates", function (messages) {
      ...
      var _iterator = _createForOfIteratorHelper$3(messages.entries()),
          _step;
    ...
    _defineProperty(_assertThisInitialized(_this), "getReadStates", function (messages) {
      ...
      var _iterator2 = _createForOfIteratorHelper$3(messages),
          _step2;
      ...
      for (var _i = 0, _Object$values = Object.values(_this.props.read); _i < _Object$values.length; _i++) {
        ...
        var _iterator3 = _createForOfIteratorHelper$3(messages),
            _step3;
    ...
    _defineProperty(_assertThisInitialized(_this), "renderItem", function (message, groupStyles) {
      if (message.type === 'message.date') {
        ...
        return /*#__PURE__*/React__default.createElement(_DateSeparator, {
          message: message
        });
      } else if (message.type === 'channel.event') {
        var _EventIndicator = _this.props.eventIndicator || _this.props.EventIndicator;

        return /*#__PURE__*/React__default.createElement(_EventIndicator, {
          event: message.event
        });
  ...
  _createClass(MessageList, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, // Mask for edit state
      this.props.editing && this.props.disableWhileEditing && /*#__PURE__*/React__default.createElement(reactNative.TouchableOpacity, {
        style: {
          position: 'absolute',
      ...
      }, /*#__PURE__*/React__default.createElement(ListContainer, _extends({
        ref: function ref(fl) {
          _this2.flatList = fl;
      ...
      }, this.props.additionalFlatListProps)), this.props.TypingIndicator && showTypingIndicator && /*#__PURE__*/React__default.createElement(TypingIndicatorContainer, null, /*#__PURE__*/React__default.createElement(TypingIndicator, {
        typing: this.props.typing,
        client: this.props.client
      })), this.state.newMessagesNotification && /*#__PURE__*/React__default.createElement(MessageNotificationWithContext, {
        showNotification: this.state.newMessagesNotification,
        onPress: this.goToNewMessages
      }), !this.state.online && /*#__PURE__*/React__default.createElement(ErrorNotification, null, /*#__PURE__*/React__default.createElement(ErrorNotificationText, null, t('Connection failure, reconnecting now ...')))));
    }
  }]);
...
var Container$l = styled__default.TouchableOpacity(_templateObject$w(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageInput.sendButton.css;
});
var SendButtonIcon = styled__default.Image(_templateObject2$p(), function (_ref2) {
  var theme = _ref2.theme;
...
var SendButton = themed((_temp$f = _class$f = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$v(SendButton);
  ...
  _createClass(SendButton, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(Container$l, {
        ...
        onPress: sendMessage,
        disabled: disabled
      }, editing ? /*#__PURE__*/React__default.createElement(SendButtonIcon, {
        source: img$h
      }) : /*#__PURE__*/React__default.createElement(SendButtonIcon, {
        source: img$i
      }));
    }
  }]);
...
var Container$m = styled__default.TouchableOpacity(_templateObject$x(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageInput.attachButton.css;
});
var AttachButtonIcon = styled__default.Image(_templateObject2$q(), function (_ref2) {
  var theme = _ref2.theme;
...
var AttachButton = themed((_temp$g = _class$g = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$w(AttachButton);
  ...
  _createClass(AttachButton, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(Container$m, {
        ...
        disabled: disabled
      }, /*#__PURE__*/React__default.createElement(AttachButtonIcon, {
        source: img$j
      }));
    }
  }]);
...
function _createForOfIteratorHelper$4(o, allowArrayLike) { var it$$1; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it$$1 = _unsupportedIterableToArray$4(o)) || allowArrayLike && o && typeof o.length === "number") { if (it$$1) o = it$$1; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it$$1 = o[Symbol.iterator](); }, n: function n() { var step = it$$1.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it$$1["return"] != null) it$$1["return"](); } finally { if (didErr) throw err; } } }; }
...
var Container$n = styled__default(function (_ref) {
  var padding = _ref.padding,
      rest = _objectWithoutProperties(_ref, ["padding"]);

  return /*#__PURE__*/React__default.createElement(reactNative.View, rest);
})(_templateObject$y(), function (_ref2) {
  var theme = _ref2.theme,
...
var EditingBoxContainer = styled__default.View(_templateObject2$r(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.messageInput.editingBoxContainer.css;
});
var EditingBoxHeader = styled__default.View(_templateObject3$i(), function (_ref5) {
  var theme = _ref5.theme;
  return theme.messageInput.editingBoxHeader.css;
});
var EditingBoxHeaderTitle = styled__default.Text(_templateObject4$f(), function (_ref6) {
  var theme = _ref6.theme;
  return theme.messageInput.editingBoxHeaderTitle.css;
});
var InputBoxContainer = styled__default.View(_templateObject5$a(), function (_ref7) {
  var theme = _ref7.theme;
  return theme.messageInput.inputBoxContainer.css;
});
var ActionSheetTitleContainer$1 = styled__default.View(_templateObject6$4(), function (_ref8) {
  var theme = _ref8.theme;
  return theme.messageInput.actionSheet.titleContainer.css;
});
var ActionSheetTitleText$1 = styled__default.Text(_templateObject7$4(), function (_ref9) {
  var theme = _ref9.theme;
  return theme.messageInput.actionSheet.titleText.css;
});
var ActionSheetButtonContainer$1 = styled__default.View(_templateObject8$3(), function (_ref10) {
  var theme = _ref10.theme;
  return theme.messageInput.actionSheet.buttonContainer.css;
});
var ActionSheetButtonText$1 = styled__default.Text(_templateObject9$2(), function (_ref11) {
  var theme = _ref11.theme;
...
var MessageInput = /*#__PURE__*/function (_PureComponent) {
  ...
  var _super = _createSuper$x(MessageInput);
  ...
  function MessageInput(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getMessageDetailsForState", function (message, initialValue) {
      ...
      if (message) {
        ...
        var _iterator = _createForOfIteratorHelper$4(message.attachments),
            _step;
    ...
    _defineProperty(_assertThisInitialized(_this), "getMembers", function () {
      var result = [];
    ...
    _defineProperty(_assertThisInitialized(_this), "getWatchers", function () {
      var result = [];
    ...
    _defineProperty(_assertThisInitialized(_this), "getUsers", function () {
      var users = [].concat(_toConsumableArray(_this.getMembers()), _toConsumableArray(_this.getWatchers())); // make sure we don't list users twice

      var uniqueUsers = {};

      var _iterator2 = _createForOfIteratorHelper$4(users),
          _step2;
    ...
    _defineProperty(_assertThisInitialized(_this), "isValidMessage", function () {
      ...
      var _iterator3 = _createForOfIteratorHelper$4(_this.state.imageOrder),
          _step3;
      ...
      var _iterator4 = _createForOfIteratorHelper$4(_this.state.fileOrder),
          _step4;
    ...
    _defineProperty(_assertThisInitialized(_this), "sendMessageAsync", function (id) {
      var image = _this.state.asyncUploads[id];
        ...
        try {
          ...
          _this.setState(function (prevState) {
            return {
              ...
              asyncIds: prevState.asyncIds.splice(prevState.asyncIds.indexOf(id), 1),
    ...
    _defineProperty(_assertThisInitialized(_this), "sendMessage", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
      var text, attachments, _iterator5, _step5, _loop, _ret, _iterator6, _step6, id, upload, updatedMessage, updateMessagePromise;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              return _this.setState({
                ...
                return _this.inputBox.clear();
              });

            case 6:
              attachments = [];
              _iterator5 = _createForOfIteratorHelper$4(_this.state.imageOrder);
              _context.prev = 8;
              ...
              _loop = function _loop() {
                ...
                if (image.state === FileState.UPLOADING) {
                  ...
                  if (_this.props.sendImageAsync) {
                    ...
                    _this.setState(function (prevState) {
                      return {
                        asyncIds: [].concat(_toConsumableArray(prevState.asyncIds), [id])
                      };
                    });
                  } else {
                    _this.sending = false;
            ...
            case 27:
              _iterator6 = _createForOfIteratorHelper$4(_this.state.fileOrder);
              _context.prev = 28;
            ...
            case 35:
              ...
              return _context.abrupt("return", _this.sending = false);
            ...
            case 50:
              if (_this.props.editing) {
                updatedMessage = _objectSpread$8({}, _this.props.editing);
                ...
                updateMessagePromise = _this.props.editMessage(updatedMessage).then(_this.props.clearEditingState);
      ...
      }, _callee, null, [[8, 21, 24, 27], [28, 42, 45, 48]]);
    })));

    _defineProperty(_assertThisInitialized(_this), "updateMessage", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
      return _regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return _this.props.client.editMessage(_objectSpread$8(_objectSpread$8({}, _this.props.editing), {}, {
                text: _this.state.text
              }));
    ...
    _defineProperty(_assertThisInitialized(_this), "_pickFile", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3() {
      var result, mimeType;
      return _regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
      ...
      _this.setState(function (prevState) {
        return {
          ...
          fileUploads: prevState.fileUploads.setIn([id], {
            id: id,
            file: _objectSpread$8(_objectSpread$8({}, file), {}, {
              type: mimeType
            }),
    ...
    _defineProperty(_assertThisInitialized(_this), "_uploadFile", /*#__PURE__*/function () {
      var _ref15 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(id) {
        ...
        return _regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 15:
                _context4.next = 17;
                return _this.props.channel.sendFile(file.uri, file.name, file.type);
    ...
    _defineProperty(_assertThisInitialized(_this), "_pickImage", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5() {
      var result;
      return _regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
    ...
    _defineProperty(_assertThisInitialized(_this), "uploadNewImage", /*#__PURE__*/function () {
      var _ref17 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(image) {
        var id;
        return _regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_uploadImage", /*#__PURE__*/function () {
      var _ref18 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(id) {
        var file, response, filename, contentType;
        return _regeneratorRuntime.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                file = _this.state.imageUploads[id].file;
              ...
              case 12:
                ...
                _this.props.channel.sendImage(file.uri, null, contentType).then(function (res) {
                  if (_this.state.asyncIds.includes(id)) {
                    // Evaluates to true if user hit send before image successfully uploaded
                    _this.setState(function (prevState) {
                      return {
                        asyncUploads: prevState.asyncUploads.setIn([id, 'state'], FileState.UPLOADED).setIn([id, 'url'], res.file)
                      };
                    });
                  } else {
                    _this.setState(function (prevState) {
                      return {
                        imageUploads: prevState.imageUploads.setIn([id, 'state'], FileState.UPLOADED).setIn([id, 'url'], res.file)
                      };
                    });
                  }
                });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderInputContainer", function () {
      ...
      return /*#__PURE__*/React__default.createElement(Container$n, {
      ...
      }, _this.state.fileUploads && /*#__PURE__*/React__default.createElement(FileUploadPreview, {
        ...
        AttachmentFileIcon: _this.props.AttachmentFileIcon
      }), _this.state.imageUploads && /*#__PURE__*/React__default.createElement(ImageUploadPreview, {
      ...
      }), /*#__PURE__*/React__default.createElement(reactNativeActionsheet.ActionSheetCustom, {
        ref: function ref(o) {
          return _this.attachActionSheet = o;
        },
        title: /*#__PURE__*/React__default.createElement(ActionSheetTitleContainer$1, null, /*#__PURE__*/React__default.createElement(ActionSheetTitleText$1, null, t('Add a file')), /*#__PURE__*/React__default.createElement(IconSquare, {
          icon: img$m,
        ...
        }), /*#__PURE__*/React__default.createElement(AttachmentActionSheetItem, {
          icon: img$l,
      ...
      }), /*#__PURE__*/React__default.createElement(InputBoxContainer, {
        ref: _this.props.setInputBoxContainerRef
      }, Input ? /*#__PURE__*/React__default.createElement(Input, _extends({}, _this.props, {
      ...
      })) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null, (hasImagePicker || hasFilePicker) && /*#__PURE__*/React__default.createElement(AttachButton$$1, {
        disabled: disabled,
        handleOnPress: /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9() {
          return _regeneratorRuntime.wrap(function _callee9$(_context9) {
            while (1) {
              switch (_context9.prev = _context9.next) {
                case 0:
      ...
      }), /*#__PURE__*/React__default.createElement(AutoCompleteInputWithContext, {
        ...
        additionalTextInputProps: additionalTextInputProps
      }), /*#__PURE__*/React__default.createElement(SendButton$$1, {
        title: t('Send message'),
        sendMessage: _this.sendMessage,
        editing: _this.props.editing,
        disabled: disabled || _this.sending || !_this.isValidMessage()
      }))));
    });

    var state = _this.getMessageDetailsForState(props.editing, props.initialValue);

    _this.state = _objectSpread$8(_objectSpread$8({}, state), {}, {
      asyncIds: Immutable([]),
      // saves data for images that resolve after hitting send
  ...
  _createClass(MessageInput, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (Object.keys(this.state.asyncUploads).length) {
         ...
         */
        this.sending = true;
        this.state.asyncIds.forEach(function (id) {
          return _this2.sendMessageAsync(id);
        });
        this.sending = false;
      }
    ...
    value: function render() {
      ...
      if (this.props.editing) {
        return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(EditingBoxContainer, null, /*#__PURE__*/React__default.createElement(EditingBoxHeader, null, /*#__PURE__*/React__default.createElement(EditingBoxHeaderTitle, null, t('Editing Message')), /*#__PURE__*/React__default.createElement(IconSquare, {
          onPress: function onPress() {
            _this3.props.clearEditingState();
          },
          icon: img$m
...
var AttachmentActionSheetItem = function AttachmentActionSheetItem(_ref21) {
  var icon = _ref21.icon,
      text = _ref21.text;
  return /*#__PURE__*/React__default.createElement(ActionSheetButtonContainer$1, null, /*#__PURE__*/React__default.createElement(IconSquare, {
    icon: icon
  }), /*#__PURE__*/React__default.createElement(ActionSheetButtonText$1, null, text));
};
...
var Container$o = styled__default.TouchableOpacity(_templateObject$z(), function (_ref) {
  var theme = _ref.theme;
  return theme.channelPreview.container.css;
});
var Details = styled__default.View(_templateObject2$s(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.channelPreview.details.css;
});
var DetailsTop = styled__default.View(_templateObject3$j(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.channelPreview.detailsTop.css;
});
var Title$2 = styled__default.Text(_templateObject4$g(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.channelPreview.title.css;
});

var _Date$1 = styled__default.Text(_templateObject5$b(), function (_ref5) {
  var theme = _ref5.theme;
  return theme.channelPreview.date.css;
});

var Message$1 = styled__default.Text(_templateObject6$5(), function (_ref6) {
  var theme = _ref6.theme,
      unread = _ref6.unread;
...
var ChannelPreviewMessenger = /*#__PURE__*/function (_PureComponent) {
  ...
  var _super = _createSuper$y(ChannelPreviewMessenger);
  ...
  function ChannelPreviewMessenger() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderAvatar", function (otherMembers) {
      var channel = _this.props.channel;
      if (channel.data.image) return /*#__PURE__*/React__default.createElement(Avatar, {
        image: channel.data.image,
        size: 40,
        name: channel.data.name
      });
      if (otherMembers.length === 1) return /*#__PURE__*/React__default.createElement(Avatar, {
  ...
  _createClass(ChannelPreviewMessenger, [{
    ...
    value: function render() {
      ...
      }, this.renderAvatar(otherMembers), /*#__PURE__*/React__default.createElement(Details, null, /*#__PURE__*/React__default.createElement(DetailsTop, null, /*#__PURE__*/React__default.createElement(Title$2, {
        ellipsizeMode: "tail",
        numberOfLines: 1
      }, name), /*#__PURE__*/React__default.createElement(_Date$1, null, formatLatestMessageDate ? formatLatestMessageDate(this.props.latestMessage.messageObject.created_at) : this.props.latestMessage.created_at)), /*#__PURE__*/React__default.createElement(Message$1, {
        unread: this.props.unread > 0 ? this.props.unread : undefined
      }, !this.props.latestMessage ? t('Nothing yet...') : truncate(this.props.latestMessage.text.replace(/\n/g, ' '), {
...
var ChannelPreview = /*#__PURE__*/function (_PureComponent) {
  ...
  var _super = _createSuper$z(ChannelPreview);
  ...
  _createClass(ChannelPreview, [{
    ...
    key: "render",
    value: function render() {
      var props = _objectSpread$9(_objectSpread$9({}, this.state), this.props);
...
var Container$p = styled__default.View(_templateObject$A(), function (_ref) {
  var theme = _ref.theme;
  return theme.channelListHeaderErrorIndicator.container.css;
});
var ErrorText$1 = styled__default.Text(_templateObject2$t(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.channelListHeaderErrorIndicator.errorText.css;
});
var ChannelListHeaderNetworkDownIndicator = withTranslationContext(function (_ref3) {
  var t = _ref3.t;
  return /*#__PURE__*/React__default.createElement(Container$p, null, /*#__PURE__*/React__default.createElement(ErrorText$1, null, t('Connection failure, reconnecting now ...')));
});
...
var Container$q = styled__default.TouchableOpacity(_templateObject$B(), function (_ref) {
  var theme = _ref.theme;
  return theme.channelListHeaderErrorIndicator.container.css;
});
var ErrorText$2 = styled__default.Text(_templateObject2$u(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.channelListHeaderErrorIndicator.errorText.css;
});
var ChannelListHeaderErrorIndicator = withTranslationContext(function (_ref3) {
  ...
  }, /*#__PURE__*/React__default.createElement(ErrorText$2, null, t('Error while loading, please reload/refresh')));
});
...
var Container$r = styled__default.View(_templateObject$C(), function (_ref) {
  var theme = _ref.theme;
...
var ChannelListFooterLoadingIndicator = function ChannelListFooterLoadingIndicator() {
  return /*#__PURE__*/React__default.createElement(Container$r, null, /*#__PURE__*/React__default.createElement(Spinner, null));
};
...
var ChannelListMessenger = withChatContext((_temp$h = _class$h = /*#__PURE__*/function (_PureComponent) {
  ...
  var _super = _createSuper$A(ChannelListMessenger);
  ...
  function ChannelListMessenger() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderHeaderIndicator", function () {
      var _this$props = _this.props,
      ...
      if (!isOnline) {
        var HeaderNetworkDownIndicator = _this.props.HeaderNetworkDownIndicator;
        return /*#__PURE__*/React__default.createElement(HeaderNetworkDownIndicator, null);
      }

      if (error) {
        var HeaderErrorIndicator = _this.props.HeaderErrorIndicator;
        return /*#__PURE__*/React__default.createElement(HeaderErrorIndicator, {
          onPress: refreshList
        });
      }
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderChannels", function () {
      return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, _this.renderHeaderIndicator(), /*#__PURE__*/React__default.createElement(reactNative.FlatList, _extends({
        ref: function ref(flRef) {
          _this.props.setFlatListRef && _this.props.setFlatListRef(flRef);
        },
        data: _this.props.channels,
        onEndReached: function onEndReached() {
          return _this.props.loadNextPage(false);
        },
        onRefresh: function onRefresh() {
          return _this.props.refreshList();
        },
        ...
        ListFooterComponent: function ListFooterComponent() {
          if (_this.props.loadingNextPage) {
            var FooterLoadingIndicator = _this.props.FooterLoadingIndicator;
            return /*#__PURE__*/React__default.createElement(FooterLoadingIndicator, null);
          }
        ...
        renderItem: function renderItem(_ref) {
          ...
          return /*#__PURE__*/React__default.createElement(ChannelPreviewWithContext, _extends({}, _this.props, {
            key: channel.cid,
            channel: channel,
...
}(React.PureComponent), _defineProperty(_class$h, "propTypes", {
   ...
   */
  HeaderNetworkDownIndicator: PropTypes.oneOfType([PropTypes.node, PropTypes.elementType]),
   ...
   */
  HeaderErrorIndicator: PropTypes.oneOfType([PropTypes.node, PropTypes.elementType]),
   ...
   */
  FooterLoadingIndicator: PropTypes.oneOfType([PropTypes.node, PropTypes.elementType]),
...
var ChannelList = withChatContext((_temp$i = _class$i = /*#__PURE__*/function (_PureComponent) {
  ...
  var _super = _createSuper$B(ChannelList);
  ...
  function ChannelList(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setStateAsync", function (newState) {
      if (_this._unmounted) {
        _this._queryChannelsDebounced.cancel();
    ...
    _defineProperty(_assertThisInitialized(_this), "wait", function (ms) {
      return new Promise(function (resolve) {
        setTimeout(resolve, ms);
      });
    });

    _defineProperty(_assertThisInitialized(_this), "queryChannelsRequest", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(filters, sort, options) {
        var retryCount,
        ...
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                retryCount = _args.length > 3 && _args[3] !== undefined ? _args[3] : 1;
                _context.prev = 1;
                _context.next = 4;
                return _this.props.client.queryChannels(filters, sort, options);
              ...
              case 13:
                return _context.abrupt("return", _this.queryChannelsRequest(filters, sort, options, retryCount + 1));

              case 14:
                return _context.abrupt("return", channelQueryResponse);
    ...
    _defineProperty(_assertThisInitialized(_this), "getQueryParams", function (queryType) {
      var _this$props = _this.props,
      ...
      if (queryType === 'refresh' || queryType === 'reload') {
        ...
        if (_this.state.channels.length === 0) {
          limit = options.limit || DEFAULT_QUERY_CHANNELS_LIMIT;
        } else if (_this.state.channels.length < MAX_QUERY_CHANNELS_LIMIT) {
          limit = Math.max(_this.state.channels.length, DEFAULT_QUERY_CHANNELS_LIMIT);
        }
      } else {
        limit = options.limit || DEFAULT_QUERY_CHANNELS_LIMIT;
      ...
      var queryOptions = _objectSpread$a(_objectSpread$a({}, options), {}, {
        offset: offset,
        limit: limit
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "setRefreshingUIState", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "setReloadingUIState", function () {
      return _this.setStateAsync({
        refreshing: false,
    ...
    _defineProperty(_assertThisInitialized(_this), "setLoadingNextPageUIState", function () {
      return _this.setStateAsync({
        refreshing: false,
        loadingChannels: false,
    ...
    _defineProperty(_assertThisInitialized(_this), "startQueryLoadingUIState", /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(queryType) {
        return _regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.t0 = queryType;
                _context2.next = _context2.t0 === 'refresh' ? 3 : _context2.t0 === 'reload' ? 6 : 9;
                break;

              case 3:
                _context2.next = 5;
                return _this.setRefreshingUIState();
              ...
              case 6:
                _context2.next = 8;
                return _this.setReloadingUIState();
              ...
              case 9:
                _context2.next = 11;
                return _this.setLoadingNextPageUIState();
    ...
    _defineProperty(_assertThisInitialized(_this), "finishQueryLoadingUIState", function () {
      return _this.setStateAsync({
        refreshing: false,
        loadingChannels: false,
        loadingNextPage: false
    ...
    _defineProperty(_assertThisInitialized(_this), "queryChannels", function (queryType) {
      // Don't query again if query is already active or there are no more results.
      _this.queryChannelsPromise = new Promise( /*#__PURE__*/function () {
        var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(resolve) {
          var _this$getQueryParams, filters, sort, options, channelQueryResponse, hasNextPage;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  _context3.prev = 0;
                  _context3.next = 3;
                  return _this.startQueryLoadingUIState(queryType);

                case 3:
                  _this$getQueryParams = _this.getQueryParams(queryType), filters = _this$getQueryParams.filters, sort = _this$getQueryParams.sort, options = _this$getQueryParams.options;
                  _context3.next = 6;
                  return _this.queryChannelsRequest(filters, sort, options);
                ...
                case 6:
                  ...
                  _this.finishQueryLoadingUIState();

                  hasNextPage = channelQueryResponse.length >= (options.limit || DEFAULT_QUERY_CHANNELS_LIMIT);
                  ...
                  _context3.next = 13;
                  return _this.setChannels(channelQueryResponse, {
                ...
                case 15:
                  _context3.next = 17;
                  return _this.appendChannels(channelQueryResponse, {
                    hasNextPage: hasNextPage,
                    error: false
                  });
                ...
                case 20:
                  ...
                  _context3.next = 24;
                  return _this.handleError(_context3.t0);
      ...
      return _this.queryChannelsPromise;
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "appendChannels", function () {
      ...
      var distinctChannels = channels.filter(function (c) {
        return _this.state.channelIds.indexOf(c.id) === -1;
      });
      distinctChannels = [].concat(_toConsumableArray(_this.state.channels), _toConsumableArray(distinctChannels));
      var channelIds = [].concat(_toConsumableArray(_this.state.channelIds), _toConsumableArray(distinctChannels.map(function (c) {
        return c.id;
      })));
      return _this.setStateAsync(_objectSpread$a({
    ...
    _defineProperty(_assertThisInitialized(_this), "setChannels", function () {
      var channels = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      var additionalState = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

      var distinctChannels = _toConsumableArray(channels);

      var channelIds = _toConsumableArray(channels.map(function (c) {
        return c.id;
      }));
    ...
    _defineProperty(_assertThisInitialized(_this), "getChannel", /*#__PURE__*/function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(type, id) {
        var channel;
        return _regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
    ...
    _defineProperty(_assertThisInitialized(_this), "refreshList", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6() {
      var now, success;
      return _regeneratorRuntime.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              now = new Date(); // Only allow pull-to-refresh 10 seconds after last successful refresh.

              if (!(now - _this.lastRefresh < 10000 && !_this.state.error)) {
                _context6.next = 3;
                break;
              }
            ...
            case 3:
              ...
              _context6.next = 7;
              return _this.queryChannels('refresh');

            case 7:
              success = _context6.sent;
              if (success) _this.lastRefresh = new Date();
    ...
    _defineProperty(_assertThisInitialized(_this), "reloadList", function () {
      _this._queryChannelsDebounced.cancel();

      _this.queryChannels('reload');
    });
    ...
    _this._queryChannelsDebounced = debounce( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7() {
      var params,
          _args7 = arguments;
      return _regeneratorRuntime.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 7:
              _this.queryChannels(params.queryType);
  ...
  _createClass(ChannelList, [{
        ...
        return _regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _context8.next = 2;
                return this.queryChannels('reload');
    ...
    key: "componentDidUpdate",
    value: function () {
      var _componentDidUpdate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9(prevProps) {
        return _regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
      ...
      function componentDidUpdate(_x9) {
        return _componentDidUpdate.apply(this, arguments);
      }
    ...
    value: function render() {
      ...
      var props = _objectSpread$a(_objectSpread$a({}, this.props), {}, {
        setActiveChannel: this.props.onSelect
      });

      return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(List, _extends({}, props, this.state, context, {
        setFlatListRef: function setFlatListRef(ref) {
          _this2.listRef = ref;
          _this2.props.setFlatListRef && _this2.props.setFlatListRef(ref);
        }
      })));
    }
  }], [{
  ...
  return ChannelList;
}(React.PureComponent), _defineProperty(_class$i, "propTypes", {
...
var NewThread = styled__default.View(_templateObject$D(), function (_ref) {
  var theme = _ref.theme;
  return theme.thread.newThread.css;
});
var NewThreadText = styled__default.Text(_templateObject2$v(), function (_ref2) {
  var theme = _ref2.theme;
...
var Thread = /*#__PURE__*/function (_React$PureComponent) {
  ...
  var _super = _createSuper$C(Thread);
...
var ThreadInner = /*#__PURE__*/function (_React$PureComponent2) {
  ...
  var _super2 = _createSuper$C(ThreadInner);
  ...
  _createClass(ThreadInner, [{
    ...
    value: function render() {
      ...
      var read = {};
      var headerComponent = /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Message, _extends({
        message: thread,
        initialMessage: true,
        threadList: true,
        readOnly: true,
      ...
      }, this.props, additionalParentMessageProps)), /*#__PURE__*/React__default.createElement(NewThread, null, /*#__PURE__*/React__default.createElement(NewThreadText, null, t('Start of a new thread'))));
      return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(MessageListComponent, _extends({
      ...
      }, additionalMessageListProps)), /*#__PURE__*/React__default.createElement(MessageInputComponent, _extends({
        parent: thread,
        focus: autoFocus,
        disabled: disabled
      }, additionalMessageInputProps)));
...
var Container$s = styled__default.View(_templateObject$E());
var Icon$1 = styled__default.View(_templateObject2$w(), function (_ref) {
  var theme = _ref.theme;
  return theme.iconBadge.icon.css;
});
var IconInner = styled__default.View(_templateObject3$k(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.iconBadge.iconInner.css;
});
var UnreadCount = styled__default.Text(_templateObject4$h(), function (_ref3) {
  var theme = _ref3.theme;
...
var IconBadge = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = _createSuper$D(IconBadge);
  ...
  _createClass(IconBadge, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Container$s, null, children, unread > 0 && /*#__PURE__*/React.createElement(Icon$1, null, /*#__PURE__*/React.createElement(IconInner, null, showNumber && /*#__PURE__*/React.createElement(UnreadCount, null, unread))));
    }
  }]);
...
exports.AutoCompleteInput = AutoCompleteInputWithContext;
exports.Card = Card;
exports.CommandsItem = CommandsItem;
exports.DateSeparator = DateSeparatorWithContext;
exports.EmptyStateIndicator = EmptyStateIndicator;
exports.EventIndicator = EventIndicatorWithContext;
exports.FileAttachmentGroup = FileAttachmentGroup;
exports.FileUploadPreview = FileUploadPreview;
exports.Gallery = GalleyWithContext;
...
exports.LoadingErrorIndicator = LoadingErrorIndicatorWithContext;
exports.LoadingIndicator = LoadingIndicatorWithContext;
exports.MentionsItem = MentionsItem;
exports.Message = Message;
exports.MessageNotification = MessageNotificationWithContext;
exports.MessageSystem = MessageSystemWithContext;
...
exports.Chat = Chat;
exports.Channel = ChannelWithContext;
exports.MessageList = MessageListWithContext;
exports.TypingIndicator = TypingIndicatorWithContext;
exports.MessageInput = MessageInputWithContext;
exports.ChannelList = ChannelList;
exports.Thread = ThreadWithContext;
exports.ChannelPreviewMessenger = ChannelPreviewMessengerWithContext;
...
exports.MessageContent = MessageContentWithContext;
