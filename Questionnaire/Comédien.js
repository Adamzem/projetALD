...
const survey = [
  ...
  },
  {
    ...
    questionText: 'Quel est ton style de comédie',
    questionId: 'favoritemusique',
    placeholderText: 'Comédie, Drame, Action',
    autoAdvance: true
  },
  {
    questionType: 'SelectionGroup',
    questionText: 'Avez vous deja fais du théatre?',
    questionId: 'instrument',
    autoAdvance: true,
    options: [
      {
        optionText: 'Oui',
  ...
  {
    questionType: 'SelectionGroup',
    questionText: 'Avez vous deja fais du Cinéma?',
    questionId: 'instrument',
    autoAdvance: true,
    options: [
      {
  ...
  {
    questionType: 'SelectionGroup',
    questionText: 'Avez vous deja fais de la publicité?',
    questionId: 'instrument',
    autoAdvance: true,
    options: [
      {
  ...
  {
    questionType: 'SelectionGroup',
    questionText: 'Avez vous deja fais des viédos sur internet ?',
    questionId: 'instrument',
    autoAdvance: true,
    options: [
      {
  ...
  {
    questionType: 'SelectionGroup',
    questionText: 'Etes vous allez dans une école de comédie?',
    questionId: 'instrument',
    autoAdvance: true,
    options: [
      {
  ...
  {
    questionType: 'TextInput',
    questionText: 'Parlez vous une langue éctrangère',
    questionId: 'favoritemusique',
    placeholderText: '',
    autoAdvance: true
  }
